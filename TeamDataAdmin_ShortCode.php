	...
	<div>
		...
		<div>
			...
			<form id="team_data_list_edit" class="team_data_admin_section">
				...
				<div class="team_data_inline">
					<label for="team_data_list_edit__show_in_registration" class="team_data_edit_label"><?php echo __('Show in Member Registration','team_data'); ?></label>
					<input id="team_data_list_edit__show_in_registration" class="team_data_admin_checkbox" name="list_show_in_registration" type="checkbox" />
				</div>
				<div class="team_data_inline">
					<label for="team_data_list_edit__registration_name" class="team_data_edit_label"><?php echo __('Registration Display Name','team_data'); ?></label>
					<input id="team_data_list_edit__registration_name" class="team_data_edit_input" name="list_registration_name" type="text" size="40" />
				</div>
				<div class="team_data_inline">
	...
	<div>
		...
		<div>
			...
			<form id="team_data_options_edit" class="team_data_admin_section">
				...
				<div class="team_data_inline">
					<label for="team_data_options_edit__registration_target"><?php echo __('Page to load after successful registration', 'team_data'); ?></label>
					<input id="team_data_options_edit__registration_target" class="team_data_edit_input" type="url" size="60" name="options_registration_target" value="<?php $registration_target = $this->get_option('registration_target'); echo $registration_target; ?>" />
					<input id="team_data_options_edit__registration_target_orig" type="hidden" value="<?php echo $registration_target; ?>" />
				</div>
				<div class="team_data_inline">
					<label for="team_data_options_edit__registration_message"><?php echo __('Message to display after successful registration', 'team_data'); ?></label><br/>
					<textarea id="team_data_options_edit__registration_message" class="team_data_edit_input" name="options_registration_message" cols="80" rows="5"><?php $registration_message = $this->get_option('registration_message'); echo $registration_message; ?></textarea>
					<textarea id="team_data_options_edit__registration_message_orig" style="display: none;"><?php echo $registration_message; ?></textarea>
				</div>
			</form>
			<div class="team_data_buttonDiv">
