...
class TeamDataBase {
	...
	public function __construct() {
		...
		$this->permitted_options = array( 'version', 'max_matches', 'current_season', 'our_team', 'registration_message', 'registration_target' );
	}
	...
	public function add_actions() {
		...
		/* add shortcodes */
		$team_data_shortcodes = new TeamDataShortcode();
		$team_data_shortcodes->add_actions();
