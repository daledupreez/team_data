...
?>
				...
				<div>
					...
					<span><?php printf( esc_html( __('The following tags and attributes are also supported: %1$s, %2$s, %3$s, %4$s', 'team_data') ), sprintf( '&lt;img src="" alt="" style="" height="" width="" class="" /&gt;' ), sprintf( '&lt;ul style="" /&gt;' ), sprintf( '&lt;ol style="" /&gt;' ), sprintf ( '&lt;li /&gt;' ) ); ?></span>
				</div>
			</form>
