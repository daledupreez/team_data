...
class TeamDataAjax extends TeamDataBase {
	...
	public function register_member() {
		...
		$responseData = $admin_ajax->put_member();
	}
	...
	public function get_stats($match_id) {
		global $wpdb;

		$sql_select = array(
			"CASE stat.value_type WHEN 0 THEN match_stat.stat_intvalue, WHEN 1 THEN match_stat.stat_stringvalue ELSE match_stat.stat_floatvalue END",
